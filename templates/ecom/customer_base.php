    ...
    <div class="container">
        <div class="row row1">
            <ul class="largenav pull-right">
                ...
                <li class="upper-links"><a class="links" href="/my-order">Ordenes</a></li>
                <li class="upper-links"><a class="links" href="/my-profile">Perfil</a></li>
        ...
        <div class="row row2">
            ...
            <div class="navbar-search smallsearch col-sm-8 col-xs-11">
              <form  action="/search" method="get">
                <div class="row"> <input class="navbar-input col-xs-11" type="buscar" placeholder="Busque Productos, marcas y mas" name="query" id="query">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div style="color:#ffffff;" class="wow fadeInUp footer-copyright">
          <p>Barrio Lagos de Suba - Aures 1
          </p><br>
          <p> Bogota-colombia <br>
          Copyright &copy; 2020 Porrlanas </p>
        </div>
      </div>
    </div>
  </div>
