...
@media screen and (max-width: 600px) {
  ...
  <br>
  <!-- products data starttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt -->
  <div class="row">
...
{%else%}
<h3 style="text-align:center; color:yellow;">No se encontró ninguna búsqueda</h3>
{%endif%}
